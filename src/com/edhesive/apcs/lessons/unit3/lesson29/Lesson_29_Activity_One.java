package com.edhesive.apcs.lessons.unit3.lesson29;
/*
...
class Lesson_29_Activity_One {
   ...
   * variable. 
   */
    public static String [] list = {"high", "every", "nearing", "checking", "food", "stand", "value", "best", "energy",
                                    "add", "grand", "notation", "abducted", "food", "stand"};
